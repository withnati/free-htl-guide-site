...
LEARNER_PREVIEW_COPY: dict[str, dict[str, object]] = {
    "study-plan.html": {
        ...
        "features": [
            "A paced plan across the major HT/HTL exam domains",
            "Study checkpoints that connect lessons with practice",
            "Progress you can continue across devices with your account",
        ],
    },
    "practice.html": {
        ...
        "features": [
            "Questions across fixation, processing, microtomy, staining, and laboratory operations",
            "Detailed explanations that reinforce the correct rule",
            "Results that contribute to weaker-domain recommendations",
        ],
    },
    "mock-exam.html": {
        ...
        "features": [
            "A 50-question practice blueprint across the major exam domains",
            "Missed-question explanations after submission",
            "Attempt history and continuation across devices",
        ],
    },
    "targeted-practice.html": {
        ...
        "features": [
            "Study mode with immediate feedback or Exam mode with end-of-set review",
            "Weaker-domain, missed-question, and flagged-question practice",
            "Saved sessions you can resume later",
        ],
    },
    "modules/processing-guide-v3.html": {
        ...
        "features": [
            ...
            "Module quiz with explanations",
            "Processing schedules, comparison tools, and study downloads",
        ],
        "proof": False,
    },
    "modules/embedding-guide-v3.html": {
        ...
        "features": [
            ...
            "Troubleshooting practice and quiz explanations",
            "Reference tools and study downloads",
        ],
    },
    "modules/staining-he-guide.html": {
        ...
        "features": [
            ...
            "Systematic artifact troubleshooting",
            "Module quiz and supporting study resources",
        ],
    },
    "modules/special-stains-guide.html": {
        ...
        "features": [
            ...
            "Target–chemistry–color review tables",
            "Module quiz and supporting reference materials",
        ],
    },
    "modules/lab-operations-guide.html": {
        ...
        "features": [
            ...
            "Module quiz and practical study tools",
        ],
    },
    "modules/ihc-ish-guide.html": {
        ...
        "features": [
            ...
            "Advanced quiz and supporting study resources",
        ],
    },
}
